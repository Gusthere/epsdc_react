export const periodosMock = [
  { parroquia: 'PRUEBADOSS', inicio: '29/05/2025', final: 'ACTIVO', diasActivo: 34, color: 'green' },
...
export const parroquias = [
  ...
  { label: 'PRUEBADOSS', value: 'PRUEBADOSS' },
  { label: 'Cuara', value: 'Cuara' },
  { label: 'Diego de Lozada', value: 'Diego de Lozada' },
